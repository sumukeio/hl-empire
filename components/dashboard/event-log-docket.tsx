...
export function EventLogDocket() {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-20 right-3 z-40 w-[min(20rem,calc(100vw-1.5rem))] sm:bottom-6 sm:right-4",
        "pointer-events-auto"
      )}
    >
      <Card
      ...
      >
        ...
        <CardContent className="space-y-1.5 pb-3 pt-0">
          {visible.length === 0 ? (
            ...
            <ul className="max-h-[11rem] space-y-2 overflow-hidden">
